...
-   Add the helm repo with `helm repo add wawa27-sd https://wawa27.github.io/stable-diffusion-k8s`
...
-   Install with `helm install --generate-name wawa27-sd/stable-diffusion -f <your-values.yaml>`
